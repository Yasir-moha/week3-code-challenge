...
movieList.appendChild(movieCapacity);
movieList.appendChild(showtime);
movieList.appendChild(ticketsAvailable);
movieList.appendChild(movieDescription);
movieList.appendChild(moviePoster);
movieList.appendChild(buyTicket);
...
function renderPlaceholderMovie(movie) {
    ...
    buyTicket.className = availableTickets > 0 ? '' : 'disabled';
